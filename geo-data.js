// =========================================================
// DONNÉES DU PROGRAMME DE GÉOGRAPHIE (Basé sur le PDF officiel)
// =========================================================
    ...
    '3e': [
        {
            ...
            icone: '🌋',
            color: '#0e7c86',
            pdf: 'geo-chapitre-1.pdf', // Ajoutez votre PDF ici si vous en avez un
            cours: `
            ...
            matieres: [
                ...
                'Exemples : Mocoa (Colombie), barrage au Laos'
            ],
            exercices: [
                { question: 'Qu\'est-ce qu\'un aléa ?', options: ['Un phénomène naturel ou technologique dangereux', 'La population vivant sur un territoire', 'Un aménagement humain', 'Un type de climat'], correct: 0, correction: 'L\'aléa est le phénomène dangereux lui-même.' },
                { question: 'Que désigne la vulnérabilité d\'un territoire ?', options: ['Sa fragilité face à un aléa', 'La taille de sa population', 'Son climat', 'Le nombre de ses routes'], correct: 0, correction: 'La vulnérabilité dépend de la population, des bâtiments et des infrastructures.' },
                { question: 'Lors d\'une éruption volcanique sur une île inhabitée, on parle...', options: ['D\'un aléa mais pas d\'un risque', 'D\'un risque maximal', 'D\'un aléa technologique', 'D\'un risque pour la population mondiale'], correct: 0, correction: 'Il y a aléa, mais pas d\'enjeu humain, donc pas de risque immédiat.' }
            ]
        },
        {
            id: 'geo3_volcans',
